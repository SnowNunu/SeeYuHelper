...
static const CGFloat showGiftView_UserIcon_WH = 40; //头像宽高
static const CGFloat showGiftView_UserName_W = 70;  //名字宽
static const CGFloat showGiftView_UserName_H = 16;  //名字高
static const CGFloat showGiftView_UserName_L = 10;//名字左
